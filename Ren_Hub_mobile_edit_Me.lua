...
if BF then
	...
	if game.CoreGui.RobloxGui:FindFirstChild("SOME X HUB ") then game.CoreGui.RobloxGui:FindFirstChild("SOME X HUB "):Destroy() end
	...
	local Main = library:Window("Ren hub","Blox Fruit")
